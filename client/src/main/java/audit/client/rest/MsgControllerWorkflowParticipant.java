...
import audit.client.BWorkflowParticipant;
...
public class MsgControllerWorkflowParticipant {
	...
	@Autowired
	public MsgControllerWorkflowParticipant(BWorkflowParticipant msgService) {//public MsgController(MsgService msgService) {//this is changed to Merge if we are to combine the classes for AuditRec verif.
